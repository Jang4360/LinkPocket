...
| [05-categories](05-categories.md) | 카테고리 CRUD·다중 분류·삭제 전파·사용자 수정 보존(AI 능동 보정 job은 범위 밖) | 02 | 3~4 | 4~6 | ✔ 삭제=연결해제+자동 재분류·보정 no-overwrite([ADR-015](../decisions/adr-015-category-deletion-and-correction-overwrite.md)) | 승인 대기 |
